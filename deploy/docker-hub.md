...
This covers **our own** 10 services + frontend only. Sunbird RC and OpenG2P are
...
`.github/workflows/docker-publish.yml` builds and pushes all 11 images on every push
